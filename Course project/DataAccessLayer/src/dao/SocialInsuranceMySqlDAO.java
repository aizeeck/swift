...
//        }
        try (Connection connection = DriverManager.getConnection(
            ...
            throw new DALException("Can not write to storage insurance  of citizen with id " + citizenId);
        }
        return last_id;
    }
    ...
    public List<SocialInsuranceRecord> select(int citizenId) throws DALException {
        ...
        try (Connection connection = DriverManager.getConnection(
            ...
            throw new DALException("Insurance record can cot be retreived from storrage. Citizen id = " + citizenId);
        }
        return result;
    }
